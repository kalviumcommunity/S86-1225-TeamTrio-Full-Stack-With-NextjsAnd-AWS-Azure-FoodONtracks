...
import { LayoutDashboard, Users, UtensilsCrossed, Package, Star, Settings, Zap } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/dashboard/admin/restaurants', label: 'Restaurants', icon: UtensilsCrossed },
